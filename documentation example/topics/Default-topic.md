...
<!--documentation example adds this topic when you create a new documentation project.
You can use it as a sandbox to play with documentation example features, and remove it from the TOC when you don't need it anymore.
